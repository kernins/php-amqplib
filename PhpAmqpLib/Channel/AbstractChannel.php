    ...
    public function __construct(AbstractConnection $connection, $channel_id)
    {
        ...
        switch ($this->protocolVersion) {
            ...
            default:
                ...
                throw new AMQPOutOfRangeException('Protocol version '.$this->protocolVersion.' not implemented.');
        }
    }
   ...
   public static function getProtocolVersion()
      {
         ...
         //adding check here to catch unknown proto ASAP, as this method may be called from the outside
         if(!in_array($proto, array(self::PROTO_080, self::PROTO_091))) throw new AMQPOutOfRangeException('Protocol version '.$proto.' not implemented.');
         return $proto;
      }
